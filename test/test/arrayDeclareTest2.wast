(module ;; Module 
    ...
    (i32.store (i32.add (get_local $arrayOffset_9a020000) (i32.const 4)) (i32.const 11))
    (i32.store (i32.add (get_local $arrayOffset_9a020000) (i32.const 8)) (i32.const 11))
    (i32.store (i32.add (get_local $arrayOffset_9a020000) (i32.const 12)) (i32.const 11))
    (i32.store (i32.add (get_local $arrayOffset_9a020000) (i32.const 16)) (i32.const 11))
    (i32.store (i32.add (get_local $arrayOffset_9a020000) (i32.const 20)) (i32.const 11))
    (i32.store (i32.add (get_local $arrayOffset_9a020000) (i32.const 24)) (i32.const 11))
    (i32.store (i32.add (get_local $arrayOffset_9a020000) (i32.const 28)) (i32.const 11))
    ;; Assign array memory data to another expression
    (set_local $c (i32.add (get_local $arrayOffset_9a020000) (i32.const -8)))
    )
