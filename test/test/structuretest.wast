...
;; Declare Function f32.toString Lib "string" Alias "toString" (x As f32) As string
    ...
    (global $global.ObjectManager (mut i32) (i32.const 452))

    ;; Memory data for string constant
        
    ;; String from 424 with 5 bytes in memory
    (data (i32.const 424) "99999\00")
    
    ;; String from 430 with 1 bytes in memory
    (data (i32.const 430) "A\00")
    
    ;; String from 432 with 4 bytes in memory
    (data (i32.const 432) "blue\00")
    
    ;; String from 437 with 4 bytes in memory
    (data (i32.const 437) "blue\00")
    
    ;; String from 442 with 4 bytes in memory
    (data (i32.const 442) "blue\00")
    
    ;; String from 447 with 4 bytes in memory
    (data (i32.const 447) "blue\00")
    
    ;; Memory data for user defined class object its meta data
    ;; all of these string is base64 encoded json object
        
    ;; String from 11 with 412 bytes in memory
    ;;
    ;; structure structuretest.[11] circle
    ;;
    (data (i32.const 11) "\00")
    ...
    (i32.store (i32.add (get_local $newObject_9a020000) (i32.const 12)) (i32.const 424))
...
;; set field [structuretest.circle::id]
(i32.store (i32.add (get_local $newObject_9b020000) (i32.const 12)) (i32.const 430))
;; set field [structuretest.circle::x]
...
(call $testStrucutre.print (call $f32.toString (f32.load (i32.add (get_local $copy) (i32.const 4)))) (i32.const 432))
(call $testStrucutre.print (call $f32.toString (f32.load (i32.add (get_local $circle) (i32.const 4)))) (i32.const 437))
...
(call $testStrucutre.print (call $f32.toString (f32.load (i32.add (i32.load (i32.add (i32.add (get_local $arrayTest) (i32.const 8)) (i32.mul (i32.const 0) (i32.const 16)))) (i32.const 8)))) (i32.const 442))
(call $testStrucutre.print (call $f32.toString (f32.load (i32.add (get_local $a) (i32.const 8)))) (i32.const 447))
)
