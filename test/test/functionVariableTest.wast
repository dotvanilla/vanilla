...
(global $Double.MinValue (mut f64) (f64.const -))
    ...
    ;; export from VB.NET module: [functionVariableTest]
    
    (export "functionVariableTest.Main" (func $functionVariableTest.Main))
    
     

    ;; functions in [functionVariableTest]
    
    (func $functionVariableTest.Main  
...
(func $Application_SubNew
    (call $functionVariableTest.constructor )
)

(func $functionVariableTest.constructor  
