...
(set_global $global.ObjectManager (i32.add (i32.add (get_local $arrayOffset_9b020000) (i32.const -8)) (i32.add (i32.const 8) (i32.mul (i32.const 1) (i32.const 8)))))
(f64.store (i32.add (get_local $arrayOffset_9b020000) (i32.const 0)) (f64.convert_s/i32 (i32.const 6666)))
