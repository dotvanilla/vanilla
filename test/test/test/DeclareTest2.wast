...
(global $Double.MinValue (mut f64) (f64.const -1.7976931348623157e+308))
    ...
    ;; export from VB.NET module: [DeclareTest2]
    
    (export "DeclareTest2.nMain" (func $DeclareTest2.nMain))
    
     

    ;; functions in [DeclareTest2]
    
    (func $DeclareTest2.nMain  
        ;; Public Function nMain() As void
