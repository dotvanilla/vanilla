...
;; Declare Function string.indexOf Lib "string" Alias "indexOf" (input As string, find As string) As i32
    ...
    (global $global.ObjectManager (mut i32) (i32.const 502))
    ...
    ;; String from 484 with 6 bytes in memory
    (data (i32.const 484) "SSSSSS\00")
    
    ;; String from 491 with 10 bytes in memory
    (data (i32.const 491) "AAAAAAAAAA\00")
    
    ;; Memory data for user defined class object its meta data
    ;; all of these string is base64 encoded json object
        
    ;; String from 15 with 468 bytes in memory
    ;;
    ;; class testNamespace.[15] circle
    ;;
    (data (i32.const 15) "\00")
...
(global $classArrayTest.str (mut i32) (i32.const 484))
(global $classArrayTest.circles (mut i32) (i32.const 0))
    ...
    (i32.store (i32.add (get_local $newObject_9a020000) (i32.const 20)) (i32.const 491))
