...
;; Declare Function i32.toString Lib "string" Alias "toString" (x As i32) As string
    ...
    (global $global.ObjectManager (mut i32) (i32.const 876))
    ...
    ;; String from 865 with 4 bytes in memory
    (data (i32.const 865) "rgb(\00")
    
    ;; String from 870 with 1 bytes in memory
    (data (i32.const 870) ",\00")
    
    ;; String from 872 with 1 bytes in memory
    (data (i32.const 872) ",\00")
    
    ;; String from 874 with 1 bytes in memory
    (data (i32.const 874) ")\00")
    
    ;; Memory data for user defined class object its meta data
    ;; all of these string is base64 encoded json object
        
    ;; String from 15 with 480 bytes in memory
    ;;
    ;; class structureArrayElement.[15] rectangle
    ;;
    (data (i32.const 15) "\00")
    
    ;; String from 496 with 368 bytes in memory
    ;;
    ;; structure structureArrayElement.[496] circle
    ;;
    (data (i32.const 496) "\00")
...
(global $rectangle.Max (mut i64) (i64.const 9223372036854775807))
    ...
    ;; class_id/typealias_enum i32 data: (i32.const 496)/array(Of intptr)
    (i32.store (get_global $global.ObjectManager) (i32.const 496))
    ...
    ;; Initialize a object instance of [[496]circle]
    ...
    ;; set field [structureArrayElement.rectangle::fill]
    (i32.store (i32.add (get_local $newObject_aa020000) (i32.const 16)) (call $string.add (call $string.add (call $string.add (call $string.add (call $string.add (call $string.add (i32.const 865) (call $i32.toString (get_global $structurearrayTest.r))) (i32.const 870)) (call $i32.toString (get_global $structurearrayTest.g))) (i32.const 872)) (call $i32.toString (get_global $structurearrayTest.b))) (i32.const 874)))
    ;; set field [structureArrayElement.rectangle::x]
